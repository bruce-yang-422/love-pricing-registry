...
本專案檔案使用 **All Rights Reserved + Custom International Commercial License**，並保留所有權利。完整條款請見 `LICENSE.md`。

本專案中的文字、圖片、角色設定、世界觀設定、程式碼與其他衍生內容，未授權任何個人、公司或組織在任何國家或地區使用、重製、改作、散布、出版、訓練模型、商業利用或非商業公開展示。

任何授權、合作、改編、翻譯、出版、影像化、遊戲化、商品化、資料使用或其他形式的使用，都必須事前取得權利人書面同意，並完成正式商業授權合約與付款安排後，方可使用。
